        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-greenbell-700 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-xl">G</span>
              </div>
              <div>
                <h3 className="font-bold text-lg leading-tight text-white">GREENBELL</h3>
                <p className="text-xs text-blue-200 -mt-1">SHADES & CANOPIES</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/car-shade-prices" className="text-blue-100 hover:text-white transition-colors">Car Shade Prices</Link></li>
